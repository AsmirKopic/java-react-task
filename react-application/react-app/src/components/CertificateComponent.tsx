...
export default function CertificateComponent({ selectedUser }: { selectedUser: string }) {
  ...
  return (
    ...
    <main className="col bg-faded py-3">
            ...
            <div className="modal-body">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <button className="btn btn-success" onClick={() => setCurrentCertificate} data-dismiss="modal">{t('submit')}</button>
      ...
      <button onClick={updateCertificate} className="btn btn-success mt-3">
        {t('submit')}
      </button>
